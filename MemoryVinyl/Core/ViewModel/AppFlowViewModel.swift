...
final class AppFlowViewModel: ObservableObject {
    ...
    @Published var showLyricOverlay: Bool = false
...
enum SongLibrary {
    static let byCategory: [String: [Song]] = [
        "蓝色夜晚": [
            ...
            Song(songName: "富士山下", artist: "陈奕迅", lyricLines: ["谁都只得那双手", "靠拥抱亦难任你拥有", "要拥有必先懂失去怎接受", "你还嫌不够"], emotionTags: ["克制", "夜色", "流动"], reason: "透视和留白明显，适合叙事慢歌。"),
            Song(songName: "后来", artist: "刘若英", lyricLines: ["后来 我总算学会了如何去爱", "可惜你早已远去", "消失在人海", "有些人 一旦错过就不在"], emotionTags: ["遗憾", "回望"], reason: "画面有旧胶片观感，适合怀旧抒情。")
        ],
        "暖色黄昏": [
            Song(songName: "小半", artist: "陈粒", lyricLines: ["我的爱意有些任性", "你是我穷极一生都做不完的梦", "我在等 风也在等"], emotionTags: ["黄昏", "温柔"], reason: "暖色低饱和适合细碎情绪表达。"),
            Song(songName: "稻香", artist: "周杰伦", lyricLines: ["还记得你说家是唯一的城堡", "随着稻香河流继续奔跑", "乡间的歌谣永远的依靠"], emotionTags: ["治愈", "轻松"], reason: "氛围偏治愈，适合抬升幸福感。"),
            Song(songName: "平凡之路", artist: "朴树", lyricLines: ["我曾经跨过山和大海", "也穿过人山人海", "我曾经失落失望失掉所有方向"], emotionTags: ["旅途", "成长"], reason: "日落叙事天然匹配旅途感歌词。")
        ]
    ]

    static let fallback: [Song] = [
        Song(songName: "夜空中最亮的星", artist: "逃跑计划", lyricLines: ["夜空中最亮的星", "请照亮我前行", "我祈祷拥有一颗透明的心灵"], emotionTags: ["城市", "夜晚", "希望"], reason: "默认情绪分组，保持稳定推荐体验。"),
        Song(songName: "慢慢喜欢你", artist: "莫文蔚", lyricLines: ["书里总爱写到喜出望外的傍晚", "我想我会开始想念你", "可是我刚刚才遇见了你"], emotionTags: ["柔软", "浪漫"], reason: "中性画面适合轻抒情。"),
        Song(songName: "成都", artist: "赵雷", lyricLines: ["和我在成都的街头走一走", "直到所有的灯都熄灭了也不停留", "你会挽着我的衣袖"], emotionTags: ["街景", "生活感"], reason: "人文和街景通用场景匹配。")
    ]
}
